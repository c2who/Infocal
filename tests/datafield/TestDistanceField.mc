...
(:test)
function testDistanceField(logger as Test.Logger) as Boolean {
    var field = new DistanceField(13);
    ...
    Test.assertMessage(true, "DistanceField methods executed successfully");
