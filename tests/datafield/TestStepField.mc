...
(:test)
function testStepField(logger as Test.Logger) as Boolean {
    var field = new StepField(30);

    Test.assertEqualMessage(field.field_id(), 30, "Field ID '" + field.field_id() + "' should be 30");
