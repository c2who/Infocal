...
(:test)
function testFloorField(logger as Test.Logger) as Boolean {
    var field = new FloorField(15);

    Test.assertEqualMessage(field.field_id(), 15, "Field ID '" + field.field_id() + "' should be 15");
