...
(:test)
function testStressField(logger as Test.Logger) as Boolean {
    var field = new StressField(31);

    Test.assertEqualMessage(field.field_id(), 31, "Field ID '" + field.field_id() + "' should be 31");
